        ...
        <div class = "flex flex-col border-1 w-122 h-119">
            <div class = "border-b-1 border-[rgb(212,214,220)] h-11">
                <ul class = "flex items-center h-full">
                    <li class="basis-1/3 flex justify-center items-center">매수</li>
                    <li class="basis-1/3 flex justify-center items-center">매도</li>
                    <li class="basis-1/3 flex justify-center items-center">거래내역</li>
                </ul>
            </div>
            <div class ="flex-col h-122 px-4 pt-4">
                ...
                <div class = "w-full h-24 p-2 mt-10">
                    <div class ="flex w-full justify-between">
                        ...
                        <button class = "w-75 h-10 border-1 bg-blue-500 text-white">매도</button>
                    </div>
